...
//			auto enabledAttr = ~static_cast<uint32_t>(0);
			bunch.add_filter(fsys::Sequence::Filter::ByAttr(0, FILE_ATTRIBUTE_READONLY | FILE_ATTRIBUTE_DIRECTORY));
//			filter.set_attr(FILE_ATTRIBUTE_HIDDEN, FILE_ATTRIBUTE_READONLY | FILE_ATTRIBUTE_SYSTEM);
		}
		{
			auto& bunch = searchOptions.add_filter_bunch(fsys::Sequence::FiltersBunch::Type::ExcludeAll, L"exclude qwe2");
